...
namespace DevelopmentChallenge.Data.Tests
{
  ...
  {
    [TestCase]
    public void TestResumeEmptyList()
    {
    ...
    [TestCase]
    public void TestResumenMultiShapes()
    {
      ...
      resumen = ShapeReportService.HtmlReport(formas, "en");
      ...
      resumen = ShapeReportService.HtmlReport(formas, "it");
