...
namespace DevelopmentChallenge.Data.Tests
{
    ...
    public class DataTests
    {
        ...
        {
            Assert.That(FormaGeometrica.Imprimir(new List<FormaGeometrica>(), 1), Is.EqualTo("<h1>Lista vacía de formas!</h1>"));
        }

        [TestCase]
        public void TestResumenListaVaciaFormasEnIngles()
        {
            Assert.That(FormaGeometrica.Imprimir(new List<FormaGeometrica>(), 2), Is.EqualTo("<h1>Empty list of shapes!</h1>"));
        }
